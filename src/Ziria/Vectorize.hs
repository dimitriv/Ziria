...
import Ziria.Vectorize.CardAnalysis -- Cardinality analysis
import Ziria.Vectorize.VecM         -- Vectorizer monad and infrastructure
import Ziria.Vectorize.VecSF
import qualified Ziria.Vectorize.VecSF as VecSF        -- Vectorization scale factors
import qualified Ziria.Vectorize.VecScaleUp as VecScaleUp
import qualified Ziria.Vectorize.VecScaleDn as VecScaleDn
