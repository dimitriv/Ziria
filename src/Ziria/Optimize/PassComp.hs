...
module Ziria.Optimize.PassComp (
    passFold
  , passPurify
  , passPurifyLetRef
  , passElimTimes
...
import Ziria.Optimize.Interpreter
import Ziria.Optimize.PassFoldDebug
import Ziria.Optimize.PassFoldM
import Ziria.Utils.Utils ( panicStr )
