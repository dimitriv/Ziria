                           ...
                           , CMD $
                             if (0 < rest) then
                              xSeq [ CMD $ y <:- takes_rest  -- xTakes rest
                                   ...
                                   , CMD $ xReturn True ya_buff
                                   ]
                             else xReturn True ya_buff
                           ]
                              ...
                              , CMD $ xReturn True (in_buff .! (in_buff_idx,n0))
                               ...
                               xSeq [ CMD $ tmp_idx .:= in_buff_idx
                                 ...
                                 -- misaligned annotations.
                                      ...
                                      , CMD $ xReturn True (in_buff .!(0::Int,n0))
                                      ]
                     ] loc
