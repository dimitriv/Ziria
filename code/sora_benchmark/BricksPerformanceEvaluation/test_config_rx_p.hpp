...
*/
static inline
FINL ISource* CreateDemodGraph11a_6_p(ISource*& svit)
{
	...
	CREATE_BRICK_FILTER (sviterbik, T11aViterbiSig, BrickTestCtx, plcp );
	CREATE_BRICK_FILTER (dibpsk, 	T11aDeinterleaveBPSK, BrickTestCtx, sviterbik );
	CREATE_BRICK_FILTER (dmplcp, 	T11aDemapBPSK::filter, BrickTestCtx, dibpsk );
	*/
...
static inline
FINL ISource* CreateDemodGraph11a_12_p(ISource*& svit)
{
	CREATE_BRICK_SINK(drop, TDropAny, BrickTestCtx);
...
static inline
FINL ISource* CreateDemodGraph11a_24_p(ISource*& svit)
{
	CREATE_BRICK_SINK(drop, TDropAny, BrickTestCtx);
